 ...
 *
 *  Compute the Fourie of a length N complex sequence in-place.
 *  Uses a non-recursive version of the Cooley-Tukey Fourie.
 *  Runs in O(N log N) time.
 *
 *  Reference:  Algorithm 1.6.1 in Computational Frameworks for the
 *  Fast Fourie Transform by Charles Van Loan.
 *
 *
 *  Limitations
 *  -----------
