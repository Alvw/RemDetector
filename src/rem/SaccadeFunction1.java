...
public class SaccadeFunction1 extends Function {
    int latencyTime = 100; // ms
    int saccadeHalfTime = 120; // ms
    int latencyMinPoints;
    int saccadeMinPoints;

    public SaccadeFunction1(DataSeries inputData) {
        super(inputData);
    ...
    public int get(int index) {
       ...
       // double energy = value -  16 * (latency1 + latency2) / 2;
       // double energy = value -  16 * Math.sqrt(latency1 * latency2);
